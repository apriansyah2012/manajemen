                    ...
                    <div class="card">
                        ...
                        <div class="body">
                          <table id="datatable" class="table responsive table-bordered table-striped table-hover display nowrap js-exportable" width="100%">
                            ...
                            <tbody>
                              <?php
                              		$sql = "SELECT reg_periksa.no_rawat , pasien.nm_pasien , reg_periksa.no_rkm_medis , penjab.png_jawab FROM reg_periksa , pasien , penjab WHERE reg_periksa.no_rkm_medis = pasien.no_rkm_medis AND reg_periksa.kd_pj = penjab.kd_pj AND reg_periksa.kd_poli='IGDK' AND reg_periksa.kd_pj='A52' AND  reg_periksa.tgl_registrasi='{$date}'";
									$list = query($sql);
                      ...
                      <div class="body">
                          <form method="post" action="objek/build-igd.php">                       
                          <form method="get">                            
                            <div class="row clearfix">
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                                <div class="form-group">
                                  <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="ppruj" value="0131R015" readonly>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                  <div class="form-line">
                                    ...
                                    <input type="text" class="form-control" name="nmruj" value="RS. KARYA HUSADA CIKAMPEK Kabupaten KARAWANG JAWA BARAT" readonly>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-4">
