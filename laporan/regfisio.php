...
$title = 'DATA KUNJUNGAN PASIEN FISIOTHERAPY';
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA KUNJUNGAN PASIEN  FISIOTHERAPY
...
)) as asuransi,sum(a.kd_pj ='A52') as bpjs,sum(a.kd_pj ='A55') as karseh,sum(a.status_lanjut ='Ralan') as rj,sum(a.status_lanjut ='Ranap') as ri, a.no_rkm_medis, sum(d.jk ='L') as Laki,sum(d.jk ='P') as Perempuan, sum(a.stts='Dirujuk') as rujuk from reg_periksa a join poliklinik b join dokter c join pasien d where a.kd_poli=b.kd_poli and a.kd_dokter=c.kd_dokter and a.kd_poli ='U0020' and a.no_rkm_medis =d.no_rkm_medis";
