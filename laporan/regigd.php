                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <table id="datatable" class="table table-bordered table-striped table-hover display nowrap js-exportable" width="100%">
                                ...
                                <tbody>
                                <?php
                                $sql = "select a.kd_poli, b.nm_poli,a.kd_dokter,c.nm_dokter, sum(a.status_poli ='Lama') as lama, sum(a.status_poli ='Baru') as baru, sum(a.kd_pj='A00') as umum, sum(a.kategori IN ('PERUSAHAAN',)) as pj, sum(a.kd_pj IN ('ASURANSI')) as asuransi,sum(a.kd_pj ='A52') as bpjs,sum(a.kd_pj ='A55') as karseh,sum(a.kd_pj ='KMK') as kemkes,sum(a.status_lanjut ='Ralan') as rj,sum(a.status_lanjut ='Ranap') as ri, a.no_rkm_medis, sum(d.jk ='L') as Laki,sum(d.jk ='P') as Perempuan, sum(a.stts='Dirujuk') as rujuk, sum(a.stts='Meninggal') as doa from reg_periksa a join poliklinik b join dokter c join pasien d join  where a.kd_poli=b.kd_poli and a.kd_dokter=c.kd_dokter and a.kd_poli ='IGDK' AND a.kd_pj=e.kd_pj and a.no_rkm_medis =d.no_rkm_medis";
