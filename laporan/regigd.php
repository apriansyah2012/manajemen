                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <table id="datatable" class="table table-bordered table-striped table-hover display nowrap js-exportable" width="100%">
                                ...
                                <tbody>
                                <?php
                                $sql = "select a.kd_poli, b.nm_poli,a.kd_dokter,c.nm_dokter, sum(a.status_poli ='Lama') as lama, sum(a.status_poli ='Baru') as baru, sum(e.kategori='TUNAI') as umum, sum(e.kategori='PERUSAHAAN') as pj, sum(e.kategori='ASURANSI') as asuransi,sum(a.kd_pj ='BPJS') as bpjs,sum(a.kd_pj ='JAMSOS') as karseh,sum(a.status_lanjut ='Ralan') as rj,sum(a.status_lanjut ='Ranap') as ri, a.no_rkm_medis, sum(d.jk ='L') as Laki,sum(d.jk ='P') as Perempuan, sum(a.stts='Dirujuk') as rujuk, sum(a.stts='Meninggal') as doa from reg_periksa a join poliklinik b join dokter c join pasien d join penjab e where a.kd_poli=b.kd_poli and a.kd_dokter=c.kd_dokter and a.kd_poli ='IGDK' and a.kd_pj=e.kd_pj and a.no_rkm_medis =d.no_rkm_medis";
