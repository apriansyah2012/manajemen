...
'A03',
'A02',
'A65')) as asuransi,sum(d.kd_pj ='A52') as bpjs,sum(d.kd_pj ='A55') as karseh from kamar_inap a join kamar b join bangsal c join reg_periksa  d join pasien e WHERE  a.kd_kamar =b.kd_kamar and b.kd_bangsal=c.kd_bangsal and a.no_rawat = d.no_rawat and d.no_rkm_medis = e.no_rkm_medis and c.status='1'";
