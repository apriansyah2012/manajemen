  <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
					 ...
					 <?php if($role == 'Admin' || $role == 'RekamMedik')  { ?>
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                          	...
                          	<?php } ?>
                          	<?php if($role == 'Admin' || $role == 'Medis' || $role == 'RekamMedik' || $role == 'Paramedis_Ranap')  { ?>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo URL; ?>/informasi_kamar.php">Ketersediaan BED</a>
                            </li>
                        </ul>
                    </li>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if($role == 'Admin' || $role == 'RekamMedik' || $_SESSION['jenis_poli'] == 'U0019')  { ?>
                      <li>
                          <a href="javascript:void(0);" class="menu-toggle">
                    ...
                    <li>
                  	...
                  	<li>
                        ...
                        <ul class="ml-menu">
			                <li>
                                <a href="<?php echo URL; ?>/obat/data-validasi.php">Validasi/Pengajuan Medis</a>
                            </li>
                            <li>
                                <a href="<?php echo URL; ?>/obat/surat-pengajuan-medis.php">Surat Permintaan Barang</a>
                            </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">update</i>
                            <span>Laporan Monev Manajemen</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">
                                    <span>Data Pasien Kunjungan</span>
                                </a>
                                <ul class="ml-menu">
                                    <!--<li>
                                        <a href="<?php echo URL; ?>/laporan/rl-1-1.php">Laporan RL 1.1</a>
                                    ...
                                    <li>
                                        <a href="<?php echo URL; ?>/laporan/rekRJ.php">Kunjungan Rawat Jalan</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo URL; ?>/laporan/regigd.php">Kunjungan IGD</a>
                                    </li>
									<li>
                                        <a href="<?php echo URL; ?>/laporan/regfisio.php">Kunjungan FISIOTHERAPY</a>
                                    </li>
									<li>
                                        <a href="<?php echo URL; ?>/laporan/regrehab.php">Kunjungan REHABILITASI MEDIK</a>
                                    </li>
									<li>
									...
									<li>
                                        <a href="<?php echo URL; ?>/laporan/regok.php">Kunjungan OK</a>
                                    </li>
                                    <li>
									...
									<li>
                                        <a href="<?php echo URL; ?>/laporan/rekRI.php">Kunjungan Rawat Inap Pandemi </a>
                                    </li>
									<li>
                                        <a href="<?php echo URL; ?>/laporan/rekRIc19.php">Kunjungan Rawat Inap </a>
                                    </li>
									<li>
                                        <a href="<?php echo URL; ?>/laporan/util.php">Utilitas dan Surveilance</a>
                                    </li>
                                </ul>
								<a href="javascript:void(0);" class="menu-toggle">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 - <?php echo date('Y'); ?> <a href="#" data-toggle="modal" data-target="#ICTRSHD">IT RS KARYA HUSADA</a>. V.4.0
                </div>
            </div>
            <!-- #Footer -->
        </aside>
