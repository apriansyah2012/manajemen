                ...
                <div class="card">
                    <div class="body">
                        <div>
							...
							<?php
                          	if (isset($_POST['bio'])) {
                            	$insert = query("UPDATE pegawai SET nama = '{$_POST['nama']}', jk = '{$_POST['jk']}', tmp_lahir = '{$_POST['tempat']}', tgl_lahir = '{$_POST['tanggal']}'
                                			, pendidikan = '{$_POST['pddkn']}', stts_wp = '{$_POST['swp']}', npwp = '{$_POST['npwp']}', alamat = '{$_POST['alamat']}',no_ktp = '{$_POST['NIK']}' WHERE nik = '{$_SESSION['username']}'");
                                	if ($insert) {
                                      	$duainsert = query("UPDATE petugas SET nama = '{$_POST['nama']}' WHERE nip = '{$_SESSION['username']}'");
                                      	if ($duainsert){
                                          redirect("profil.php");
                                        }
                                    };
